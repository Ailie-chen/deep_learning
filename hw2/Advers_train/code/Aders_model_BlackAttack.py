...
for i in range(10):
    ...
    save_image(origin_img, f"Advers_train/BlackAttack_samples/{i}raw_label_{label}.png")
    save_image(attacked_img, f"Advers_train/BlackAttack_samples/{i}attacked_label_{incorrect_label}.png")
