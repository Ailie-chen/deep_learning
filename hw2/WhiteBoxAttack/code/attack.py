...
for i in range(10):
    ...
    save_image(origin_img, f"WhiteBoxAttack/attacked_samples/{i}raw_label_{correct_label}.png")
    save_image(attacked_img, f"WhiteBoxAttack/attacked_samples/{i}attacked_label_{incorrect_label}.png")
