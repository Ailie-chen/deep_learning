...
if __name__ == "__main__":
    ...
    # 添加一层隐藏层
    model1 = NeuralNetwork(input_size=784, output_size=10, layer_sizes=[256, 256, 256])
    loss_train1, acc_train1, loss_val1, acc_val1 = train(model1, train_data, train_labels, 
                                                         test_data, test_labels, num_epochs=20, 
                                                         learning_rate=1e-1)

    plot_learning_curve(loss_train1, acc_train1, loss_val1, acc_val1, "hw1-1/add_layer_curve.png")

    # 减少一层隐藏层
    model2 = NeuralNetwork(input_size=784, output_size=10, layer_sizes=[256])
    loss_train2, acc_train2, loss_val2, acc_val2 = train(model2, train_data, train_labels, 
                                                         test_data, test_labels, num_epochs=20, 
                                                         learning_rate=1e-1)

    plot_learning_curve(loss_train2, acc_train2, loss_val2, acc_val2, "hw1-1/delete_layer_curve.png")
